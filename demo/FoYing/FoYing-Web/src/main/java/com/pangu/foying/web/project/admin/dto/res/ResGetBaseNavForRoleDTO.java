 ...
 * @Modified By
 */
public class ResGetBaseNavForRoleDTO {
    @Mapping("id")
    ...
    private ResGetSubBaseNavForRoleDTO checkArr;
    ...
    public ResGetSubBaseNavForRoleDTO getCheckArr() {
        return checkArr;
    }

    public void setCheckArr(ResGetSubBaseNavForRoleDTO checkArr) {
